...
1. If you want quick access to data on companies, investors or deals, simply use the search box or use the menu to browse through all the records. You don't need to be registered or logged in.

2. If you want to insert or edit information, you need to create an account. Once you are logged in, you will be able insert new records or edit the existing information.
